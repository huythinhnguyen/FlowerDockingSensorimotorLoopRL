# SAME WITH EXP 1 BUT REPLAN EVERY STEP
import sys
import os
import numpy as np
...
SAVE_DATA_PATH = os.path.join(REPO_PATH, 'experiments', 'data', 'exp_1B')
...
def run_1_trial(bat_pose: ArrayLike, flower_pose: ArrayLike,
    ...
    control_loop = HomeInFlower(pose_estimator=OnsetOneShotFlowerPoseEstimator(),
                                init_v=INIT_VELOCITY, caching=True, replan_every_step = REPLAN_EVERY_STEP)
    distance_traveled = 0.
